                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                          ...
                          <ul class="mb-3 nav nav-pills flex-column flex-md-row">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" href="/contactproduct/notas/{{ $pedido->id }}"><i class="bx bx-note me-1"></i>Notas Internas</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="/contactproduct/status/{{ $pedido->id }}"><i class="bx bx-detail me-1"></i>Cambiar Estado</a>
                            </li>
                          ...
                          <!-- /Project table -->
                          <livewire:contacproduct::status-contacproduct :pedido="$pedido" />
