<x-layout>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                        ...
                        <ul class="mb-3 nav nav-pills flex-column flex-md-row">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/contactproduct/status/{{ $pedido->id }}"><i
                        ...
                        <!-- /Project table -->
                        <livewire:notes::note-list :pedido="$pedido->id" model='productos' />
    ...
    <livewire:notes::create-note :pedido="$pedido->id" model='productos' />
